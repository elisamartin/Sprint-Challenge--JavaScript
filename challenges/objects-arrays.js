...
zooAnimals.forEach(function(animal) {
	let fullName = 'Name: ' + animal.animal_name + ', Scientific: ' + animal.scientific_name;
...
const smallerPopulation = zooAnimals.filter(checkSmallPop);
function checkSmallPop(animal) {
